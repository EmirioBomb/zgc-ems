...
import com.zgc.zhaopin.persistence.mapper.SysUserMapper;
import com.zgc.zhaopin.util.IpUtil;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public JSONObject insertListWithChecked(List<SysUser> sysUsers, SysUserService userService) {
        ...
        Assert.notNull(sysUsers, "sysDepts不能为空");
        for (SysUser sysDept : sysUsers) {
            if (sysDept.getId() == null) {
                continue;
            }
            userList.add(new User(sysDept));
        }

        for (User user : userList) {
            if (getByPrimaryKey(user.getId()) == null) {
            ...
            } else if (getByPrimaryKey(user.getId()) != null) {
    ...
    public Long checkCurrentMaxID() {
        Long maxId = sysUserMapper.checkCurrentMaxID();
        return maxId;
    }
